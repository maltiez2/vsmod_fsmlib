...
public abstract class BaseResist : IResist
{
    ...
    public virtual void ResistCallback(DamageSource damageSource, ref float damage, Entity receiver, IResistEntityBehavior? resistHolder) => mCallback?.Invoke(this, damageSource, ref damage, receiver);

    public virtual void SetResistCallback(DamageSourceCallback callback) => mCallback = callback;
...
public class ConstResist : BaseResist, IConstResist
{
    ...
    public void Init(JsonObject[] resists, EntityBehavior? behavior)
    {
        mBehavior = behavior;
...
public class TempResist : BaseResist, ITempResist
{
    ...
    public void Start(IResistEntityBehavior? behavior, ICoreAPI? api = null, int? timeout_ms = null, int? attacksThreshold = null, float? damageThreshold = null)
    {
    ...
    private void StartTimer(int? timeout_ms = null)
    {
    ...
    private void SetAttacksThreshold(int? attacksThreshold = null) => mAttacksThreshold = attacksThreshold;
    ...
    private void SetDamageThreshold(float? damageThreshold = null) => mDamageThreshold = damageThreshold;
...
public class DirectionalResist : TempResist, IDirectionalResist
{
    ...
    protected virtual bool CheckDirection(Entity? receiver, Entity? source, bool horizontal = true)
    {
        ...
        if (receiver is not EntityPlayer player || source == null) return false;
    ...
    bool IDirectionalResist.Check(Entity? receiver, Entity? source) => CheckDirection(receiver, source, mHorizontal);
...
public class BlockOrParryResist : DirectionalResist
{
    ...
    {
        ImmutableHashSet<EnumDamageType> damageTypesToAdd = damageTypes ?? defaultDamageTypes;
        List<Utils.DamageModifiers.TieredModifier> modifiersToAdd = modifiers ?? new() { defaultModifier };
